inventoryModules.inventoryTable = (() => {
    ...
    function createTable({
        ...
        function priceLabel(item) {
            ...
            const hasMarketValue = !isGem && (item.marketable || (item.marketHashName && (item.hasTemporaryHold || (isApp753 && (item.gem?.eligible || item.type === 'Booster Pack')) || (!isApp753 && item.hasMarketActions))));
